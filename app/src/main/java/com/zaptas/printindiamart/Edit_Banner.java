...
public class Edit_Banner extends AppCompatActivity {
    ...
    String base64img,se_id,banner_id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update__banner);
        ...
        banner_id = bundle.getString("int_subcategory_id");
    ...
    private void selectImage() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Edit_Banner.this);
        builder.setTitle("Add Photo of "+document_type);
        builder.setItems(items, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                boolean result = Utility.checkPermission(Edit_Banner.this);
    ...
    private void cameraIntent() {
        ...
        boolean result = Utility.checkPermission_camera(Edit_Banner.this);
        if (result)
        {
            Intent takePictureIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
    ...
    public class DocumentData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            dialog = new ProgressDialog(Edit_Banner.this);
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("https://printindiamart.com/public/api/seller_update_image"); // here is your URL path
               ...
               /* postDataParams.put("name", "abc");
                ...
                postDataParams.put("id", banner_id);
        ...
        protected void onPostExecute(String result) {
            ...
            dialog.dismiss();
            Intent intent = new Intent(Edit_Banner.this, Seller_Banner.class);
