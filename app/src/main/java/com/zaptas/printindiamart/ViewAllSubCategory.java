...
public class ViewAllSubCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        c_Data = in.getStringExtra("int_cat_data");
    ...
    class GetData_Viewall extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(ViewAllSubCategory.this);
            ...
            try {
                if (jsonObject != null) {
                    if (jsonObject.length() > 0) {
                        ...
                        JSONArray array1 = array.getJSONArray("children");
                        ...
                        if (lenArray > 0) {
                            for (int jIndex = 0; jIndex < lenArray; jIndex++) {
                                ...
                                JSONObject innerObject = array1.getJSONObject(jIndex);
                                String subcategory_id1 = innerObject.getString("id");
                                String name1 = innerObject.getString("subcat_name");
                                String cname1 = innerObject.getString("simage");
                                String decription1 = innerObject.getString("parent_id");
    ...
    public static JSONObject getDataFromWeb() {
        try {
            ...
            Request request = new Request.Builder()
                    ...
                    .url("https://printindiamart.com/public/api/get_childcategory/" + c_Id)
                    .build();
