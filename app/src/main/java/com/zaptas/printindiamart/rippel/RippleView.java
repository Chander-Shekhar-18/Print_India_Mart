package com.zaptas.printindiamart.rippel;
...
public class RippleView extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleView_rv_color, ContextCompat.getColor(context, R.color.rippelColor));
    ...
    /**
     * Send a click event if ParentNav view is a Listview instance
     *
    ...
    /**
     * Set if ripple animation has to be centered in its ParentNav view or not, default is False
     *
     * @param isCentered
     */
