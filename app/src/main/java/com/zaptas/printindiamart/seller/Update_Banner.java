...
public class Update_Banner extends AppCompatActivity {
    ...
    private void selectImage() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(Update_Banner.this);
        builder.setTitle("Add Photo of "+document_type);
        builder.setItems(items, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int item) {
                boolean result = Utility.checkPermission(Update_Banner.this);
    ...
    private void cameraIntent() {
        ...
        boolean result = Utility.checkPermission_camera(Update_Banner.this);
        if (result)
        {
            Intent takePictureIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
...
d=2;
    ...
    public class DocumentData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            dialog = new ProgressDialog(Update_Banner.this);
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("https://printindiamart.com/public/api/add_seller_banner"); // here is your URL path
        ...
        protected void onPostExecute(String result) {
            ...
            dialog.dismiss();
            Intent intent = new Intent(Update_Banner.this, Seller_Banner.class);
